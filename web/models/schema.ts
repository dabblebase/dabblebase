...
export interface paths {
  ...
  "/api/assignment/{assignment_id}/unpublish": {
     ...
     * @description Unpublish an assignment.
     *
     *     This endpoint allows staff to unpublish an assignment, making it
     *     unavailable to students.
     */
    put: operations["unpublish_assignment_api_assignment__assignment_id__unpublish_put"];
    post?: never;
    delete?: never;
    options?: never;
    head?: never;
  ...
  "/api/assignment/{assignment_id}/republish": {
    ...
    get?: never;
    /**
     * Republish Assignment
     * @description Republish an assignment.
     *
     *     This endpoint allows staff to republish an assignment, making it
     *     available to students again.
     */
    put: operations["republish_assignment_api_assignment__assignment_id__republish_put"];
    post?: never;
    delete?: never;
    options?: never;
    head?: never;
...
export interface components {
  schemas: {
    ...
    server__models__assignment__GetDropdownResponse: {
      ...
      is_staff: boolean;
      selected_assignment?:
        | components["schemas"]["GetDropdownResponse_Assignment"]
        | null;
      /** Assignments */
    ...
    server__models__course__GetDropdownResponse: {
      ...
      terms: string[];
      selected_course?:
        | components["schemas"]["GetDropdownResponse_Course"]
        | null;
      /** Courses */
      courses: {
  ...
  get_summary_api_profile_summary_get: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json":
            | components["schemas"]["GetProfileSummaryResponse"]
            | null;
        };
      };
      /** @description Validation Error */
